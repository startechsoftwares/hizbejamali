...
<body>
    <div id="wrapper">
        <asp:PlaceHolder ID="plcMemberCount" runat="server" Visible="false">
            <div id="txtblnk">
                <p><strong><font color="red">Current Member's Count:-<asp:Label ID="lblcount" runat="server"></asp:Label></font></strong></p>
            </div>
        </asp:PlaceHolder>
        <!-- Begin header -->
        <div id="header" align="center">
            ...
            <div id="left_section">
                <img src="images/logo.png" height="80" border="0" alt="" class="logo" /></div>
        ...
        <div id="slider">
            <img src="images/slideshow/slides/slide1.png" alt="" />
            <img src="images/slideshow/slides/slide2.png" alt="" title="#htmlcaption" />
            <img src="images/slideshow/slides/slide3.png" alt="" />
            <img src="images/slideshow/slides/slide4.png" alt="" />
        </div>
        ...
        <div id="top_content">
            ...
            <div class="dotted_line"></div>
            Hizbe jamali was founded with raza of Al Hayyul Muqaddas Syedna Mohammed Burhanuddin RA in 1433 Hijri (March 2012 AD).<br />
            <br />

            The main purpose to form this committee is to obtain Syedna Mohammed Burhanuddin RA & Syedna Mufaddal Moula TUS Khushi and Doa Mubarak by sending Mumineen & Mumenaat to Karbala Moalla & Najaf E Ashraf Ziyarat Mubarak.<br />
            <br />

            We have started this azeem khidmat on the occasion of 101 ST Milad Mubarak of Syedna Mohammed Burhanuddin RA by contributing 500 INR Monthly. Initially total strength of committee was 65members and later more and more people joined the group by making monthly & voluntary contribution. Not only from Mumbai but we received overwhelming response from Dubai, Pune, Kuwait, Daress Salaam etc. On April 2012 the committee got sharaf of sending one mumin bhai to Karbala Moalla & Najaf E Ashraf Ziyarat Mubarak As months passed away strength of Hizbe Jamali got increased and Hizbe Jamali got sharaf of sending 5 more mumineen in Sept 2012 to Karbala Moalla & Najaf E Ashraf Ziyarat Mubarak
            <br />
            <br />

            Meanwhile committee also got azeem sharaf of ziyafat of Syedna Mohammed Burhanuddin RA on 3 zilhajj 1433 17 oct 2012 at Khanadala.<br />
            <br />
            ...
            The main objective behind making this website is to share our experience that niyyat of sending mumineen to Imam Husain AS ziyarat turned our lifestyles completely & more aala tasawwur is Imam Husain AS naa Daai gave us sharaf of Ziyafat. Also thru this website we aim to encourage people to join Hizbe Jamali.<br />
            <br />

            Beside these milestones there're uncountable success and achievements in our members' lives individually and cummulatively with blessing and benediction of Syedna Mohammed Burhanuddin RA & Syedna Mufaddal Moula TUS. And it's now going to be manifold with barakaat and behjat of both Moulas in the days to come.<br />
            <br />

            Our objective is for sure...<br />
            <br />

            Khuda Syedna Mohammed Burhanuddin RA ne Janntaul Firdaus maa Afzalul Jazaa aapjo ane apnaa janasheen ane haqaan haqaa mansoos Syedna Mufaddal Saifuddin TUS ne jaha tak mumineen Karbala Moalla ni ziyarat si behrowar thata rahe waha lag aap ni umar shareef ni daraaz ane daraaz karjo. Ameen..
            <br />
            <br />

            Ameen!
            <br />
            Shukriya & Iltemaas-ud-doa!
            <br />
