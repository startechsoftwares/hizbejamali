<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="mastertravel.aspx.vb" Inherits="Hizbe_Jamali_Web.mastertravel" %>
            ...
            <asp:PlaceHolder ID="plcMainContent" runat="server" Visible="false">
                ...
                <div id="content">
                    <div id="contact_us_left_coloumn">
                        <h2>Travel Agent's Registeration</h2>
                        ...
                        <asp:Table ID="Table2" runat="server">
                            <asp:TableRow>
                                <asp:TableCell>
                                    <asp:Button ID="btnSearch" runat="server" Text="New Member's Registration" /></asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                                <asp:TableCell>
                                ...
                                <asp:TableCell Width="100%">
                                    <asp:GridView ID="GridView2" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="False" GridLines="None" HeaderStyle-Width="100px" CssClass="mGrid" AllowPaging="True" Width="100%" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowCancelingEdit="GridView2_RowCancelingEdit" OnRowDataBound="GridView2_RowDataBound" OnRowDeleting="GridView2_RowDeleting" OnRowEditing="GridView2_RowEditing" OnRowUpdating="GridView2_RowUpdating" PagerSettings-PageButtonCount="20" PageSize="20">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Account_No" HeaderText="Code" ReadOnly="True" SortExpression="Account_No" />
                                            <asp:BoundField DataField="Supplier_Name" HeaderText="Travel Agent's Name" ReadOnly="True" SortExpression="Supplier_Name" />
                    ...
                    <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Height="350px" Width="600px" Style="display: none">
                        <table width="100%" style="border: Solid 3px #D55500; width: 100%; height: 70%" cellpadding="0" cellspacing="0">
                            <tr style="background-color: #D55500">
                                <td colspan="2" style="height: 7%; color: White; font-weight: bold; font-size: larger" align="center">Member's Details</td>
                            </tr>
                            <tr>
                                <td style="width: 45%">Account Code:
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtSupplierName" runat="server" CssClass="tb5"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Contact Person:
                                ...
                                <td>
                                    <asp:TextBox ID="txtContact" runat="server" CssClass="tb5"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Telephone:
                                ...
                                <td>
                                    <asp:TextBox ID="txtTelephone" runat="server" CssClass="tb5small"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Fax:
                                ...
                                <td>
                                    <asp:TextBox ID="txtFax" runat="server" CssClass="tb5small"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Mobile:
                                ...
                                <td>
                                    <asp:TextBox ID="txtMobile" runat="server" CssClass="tb5small"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Address:
                                ...
                                <td>
                                    <asp:TextBox ID="txtAddress" runat="server" CssClass="tb5"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Email:
