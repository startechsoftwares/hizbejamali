<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="bayaan.aspx.vb" Inherits="Hizbe_Jamali_Web.bayaan" %>
...
<div id="wrapper">
  ...
  <!-- Begin top content -->
  <div id="top_content">
  <h1><span style="color:#08a5ff;">Bayaan Mubarak</span> </h1>
  <div class="dotted_line"></div>
      <asp:Table ID="Table1" runat="server" HorizontalAlign="Center">
      <asp:TableRow>
      <asp:TableCell><asp:Image ID="Image2" runat="server" ImageUrl="images/maulas.jpg" Height="80%" Width="100%" /></asp:TableCell>
      <asp:TableCell>
      <asp:Image ID="Image1" runat="server" ImageUrl="images/MBBayan1.png" />
      </asp:TableCell>
      </asp:TableRow>
      <asp:TableRow>
      <asp:TableCell>
