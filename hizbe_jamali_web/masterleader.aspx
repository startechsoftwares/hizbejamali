<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="masterleader.aspx.vb" Inherits="Hizbe_Jamali_Web.masterleader" %>
            ...
            <asp:PlaceHolder ID="plcMainContent" runat="server" Visible="false">
                ...
                <div id="content">
                    <div id="contact_us_left_coloumn">
                        <h2>Group Leader Registeration Form</h2>
                        ...
                        <asp:Table ID="Table2" runat="server">
                            <asp:TableRow>
                                <asp:TableCell>
                                    <asp:Button ID="btnSearch" runat="server" Text="New Leader's Registration" /></asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                                <asp:TableCell>
                                ...
                                <asp:TableCell Width="100%">
                                    <asp:GridView ID="GridView2" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="False" GridLines="None" HeaderStyle-Width="100px" CssClass="mGrid" AllowPaging="True" Width="100%" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowCancelingEdit="GridView2_RowCancelingEdit" OnRowDataBound="GridView2_RowDataBound" OnRowDeleting="GridView2_RowDeleting" OnRowEditing="GridView2_RowEditing" OnRowUpdating="GridView2_RowUpdating" PagerSettings-PageButtonCount="20" PageSize="20">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="EjamaatID" HeaderText="ITS ID" ReadOnly="True" SortExpression="Ejamaat" />
                                            <asp:BoundField DataField="MemberName" HeaderText="Short Name" ReadOnly="True" SortExpression="Name" />
                                            <asp:BoundField DataField="Password" HeaderText="Password" ReadOnly="True" SortExpression="MPW" />
                                            <asp:BoundField DataField="MemberType" HeaderText="Access" ReadOnly="True" SortExpression="Type" />
                    ...
                    <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Height="300px" Width="600px" Style="display: none">
                        <table width="100%" style="border: Solid 3px #D55500; width: 100%; height: 100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td>Leader Short Name:
                                </td>
                                <td>
                                    <asp:TextBox ID="txtNameshort" runat="server" CssClass="tb5small"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Leader Full Name:
                                ...
                                <td>
                                    <asp:TextBox ID="txtNamefull" runat="server" CssClass="tb5"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Password:
                                ...
                                <td>
                                    <asp:TextBox ID="txtPW" runat="server" CssClass="tb5small"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Access Type:
                                ...
                                <td>
                                    <asp:DropDownList ID="cboxRights" runat="server"></asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
