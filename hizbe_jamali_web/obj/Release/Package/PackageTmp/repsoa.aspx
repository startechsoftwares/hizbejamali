 ...
 <div id="contact_us_left_coloumn">
  ...
  <div class="dotted_line"></div>
       ...
       <asp:Table ID="Table3" runat="server">
        <asp:TableRow>
        <asp:TableCell><asp:Label ID="Label4" runat="server" Text="Filter By Group:-"></asp:Label></asp:TableCell>
        <asp:TableCell><asp:DropDownList ID="cboxGroupLeader" runat="server" CssClass="cbox" AutoPostBack="True"></asp:DropDownList></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
        <asp:TableCell><asp:Label ID="Label3" runat="server" Text="Name:-"></asp:Label></asp:TableCell>
        <asp:TableCell><asp:DropDownList ID="cboxMname" runat="server" CssClass="cboxbig"></asp:DropDownList></asp:TableCell>
        </asp:TableRow>
       </asp:Table>
       ...
       <asp:Table ID="Table8" runat="server" Width="100%">
        ...
        <asp:TableRow>
         <asp:TableCell><asp:Label ID="Label5" runat="server" Text="Account Balance:-" Font-Size="Small" CssClass="label"></asp:Label></asp:TableCell>
         <asp:TableCell><asp:Label ID="lblAccountBal" runat="server" CssClass="label1"></asp:Label></asp:TableCell>
         </asp:TableRow>
        </asp:Table>
