...
<div id="wrapper">
 ...
 <h2>Zaereen's Verification Form</h2>
  <div class="dotted_line"></div>
        ...
        <asp:TableRow>
        <asp:TableCell><asp:Label ID="Label1" runat="server" Text="Filter Records By:- "></asp:Label></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
        <asp:TableCell><asp:Label ID="Label2" runat="server" Text="Status: "></asp:Label></asp:TableCell>
        <asp:TableCell><asp:DropDownList ID="cboxStatusZ" runat="server" AutoPostBack="True"></asp:DropDownList></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
        <asp:TableCell>
        <asp:Button ID="btnExcel" runat="server" Text="Export To Excel" /></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
...
<td colspan="1" style=" height:5%; color:White; font-weight:bold; font-size:larger" align="left"><img src="images/logo.png" width="120" height="100" border="0" alt="" class="logo" /></td><td colspan="3" style=" height:5%; color:White; font-weight:bold; font-size:xx-large; font-family: 'Times New Roman';" align="center">Zaereen Verification Form</td>
</tr>
<tr>
<td width="250px" style="border-style: solid; border-width: thin; font-family: Arial; font-weight: bold;">
Trans No:
</td>
...
<tr>
<td width="200px" style="border-style: solid; border-width: thin; font-family: Arial; font-weight: bold;">
ITS ID:
</td>
<td width="400px" style="border-style: solid; border-width: thin; font-family: Arial;">
