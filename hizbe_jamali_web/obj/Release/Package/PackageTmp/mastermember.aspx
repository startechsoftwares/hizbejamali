        ...
        <div id="wrapper">
            ...
            <div id="content">
                    ...
                    <asp:Table ID="Table2" runat="server">
                        <asp:TableRow>
                            ...
                            <asp:TableCell HorizontalAlign="Right">
                                <asp:Label ID="Label1" runat="server" Text="Filter By:-"></asp:Label><asp:DropDownList ID="cboxStatus1" runat="server" Width="250px" AutoPostBack="True"></asp:DropDownList></asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            <asp:TableCell>
                ...
                <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Height="53%" Width="50%" Style="display: none">
                    ...
                    <table width="100%" style="border: Solid 3px #D55500; width: 100%; height: 100%; display: none;" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="cboxGrpLeaderAJ" runat="server" CssClass="cbox"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>Mobile:
