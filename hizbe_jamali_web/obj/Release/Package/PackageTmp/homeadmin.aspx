<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="homeadmin.aspx.vb" Inherits="Hizbe_Jamali_Web.homeadmin" %>
    ...
    <div id="right_section" style="width: 500px; ">
      ...
      <asp:Table ID="Table7" runat="server">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell><asp:Label ID="lblLeader" runat="server" Text="Label"></asp:Label></asp:TableCell>
        </asp:TableRow>
 ...
 <div id="contact_us_left_coloumn">
  ...
  <div class="dotted_line"></div>
       <asp:Table ID="Table1" runat="server">
              ...
              <asp:TableCell><asp:Image ID="Image1" runat="server" Width="50%" /></asp:TableCell>
              </asp:TableRow>
       </asp:Table>
