<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ForgotPassword.aspx.vb" Inherits="Hizbe_Jamali_Web.ForgotPassword" %>
...
<div id="wrapper">
  ...
  <!-- Begin top content -->
  <div id="top_content">
  <h1><span style="color:#08a5ff;">Forgot Password</span> </h1>
  <div class="dotted_line"></div>
     <asp:Panel ID="Panel1" runat="server" DefaultButton="btnForgotPassword">

         <asp:Label ID="lblMessage" runat="server" Visible="false"></asp:Label>
  <table align="center" frame="box"color: #FFCC66; border-width: 5px;" width="35%" style="border-color: #000000; margin-bottom: 20px;">
    ...
    <td>
      ...
      <tr>
          <td><asp:Button ID="btnForgotPassword" runat="server" Text="Get Password" CssClass="button" OnClick="btnForgotPassword_Click" /></td>
      </tr>
      <tr>
          <td colspan="2" align="center">
          <asp:Label ID="lblMissing" runat="server" Text="Note: Your credentials will be sent to your registered email id." ForeColor="Red" Font-Bold="True" Font-Size="Small"></asp:Label>
              </td>
      </tr>
</table>
