<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="trfv.aspx.vb" Inherits="Hizbe_Jamali_Web.trfv" %>
...
{
 document.getElementById('txtAmtDHS').value = document.getElementById('txtAmtIRS').value * document.getElementById('txtRate').value
  } 
  
   function SetRemarks()
{
 document.getElementById('txtRemarks').value = document.getElementById('txtAmtIRS').value + "INR Sent for Karbala Cause"
  } 
...
<td>
<asp:DropDownList ID="cboxFCYAg" runat="server" ></asp:DropDownList>
</td>
</tr>
<tr>
<td>
...
<td>
<asp:TextBox ID="txtAmtIRS" runat="server" MaxLength="100" ></asp:TextBox>
</td>
</tr>
<tr>
<td>
...
<td>
<asp:TextBox ID="txtRate" runat="server" MaxLength="100" ></asp:TextBox>
</td>
</tr>
<tr>
<td>
...
<td>
<asp:TextBox ID="txtAmtDHS" runat="server" MaxLength="100" onfocus="SetTextInTextBox2()"></asp:TextBox>
</td>
</tr>
<tr>
<td>
...
<td>
<asp:TextBox ID="txtRemarks" runat="server" MaxLength="100" CssClass="tb5a" onfocus="SetRemarks()"></asp:TextBox>
</td>
</tr>
<tr>
<td>
