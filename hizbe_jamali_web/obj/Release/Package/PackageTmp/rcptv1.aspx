...
<td>
<asp:DropDownList ID="cboxSname" runat="server" CssClass="cbox" Width="400px"></asp:DropDownList>
</td>
</tr>
<tr>
<td>
...
<asp:Button ID="btnSubmit" runat="server" Text="Save" CssClass="button" Width="80px" />
<asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="button" Width="80px" />
 ...
 <asp:Table ID="Table3" runat="server" Width="100%" >
        <asp:TableRow>
        <asp:TableCell><h4><asp:Label ID="Label3" runat="server" Text="Member:-"></asp:Label></h4></asp:TableCell>
        <asp:TableCell><asp:DropDownList ID="cboxMemberName" runat="server" CssClass="cbox" Width="300px"></asp:DropDownList></asp:TableCell>
