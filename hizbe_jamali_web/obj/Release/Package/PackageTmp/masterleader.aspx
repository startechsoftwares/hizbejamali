...
<div id="wrapper">
 ...
 <h2>Group Leader Registeration Form</h2>
  <div class="dotted_line"></div>
        ...
        <asp:TableRow>
        <asp:TableCell><asp:Button ID="btnSearch" runat="server" Text="New Leader's Registration" /></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
        ...
        <asp:BoundField DataField="Name" HeaderText="Short Name" ReadOnly="True" SortExpression="Name" /> 
        <asp:BoundField DataField="MPW" HeaderText="Password" ReadOnly="True" SortExpression="MPW" /> 
        <asp:BoundField DataField="Type" HeaderText="Access" ReadOnly="True" SortExpression="Type" /> 
