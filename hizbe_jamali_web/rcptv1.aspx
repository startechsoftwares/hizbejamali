<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="rcptv1.aspx.vb" Inherits="Hizbe_Jamali_Web.rcptv1" %>
                    ...
                    <div id="contact_us_left_coloumn">
                        ...
                        <asp:Table ID="Table3" runat="server" Width="100%">
                            <asp:TableRow>
                                ...
                                <asp:TableCell>
                                    <asp:DropDownList ID="cboxMemberName" runat="server" CssClass="cbox" Width="300px" AutoPostBack="true" OnSelectedIndexChanged="cboxMemberName_SelectedIndexChanged"></asp:DropDownList></asp:TableCell>
                                <asp:TableCell>
                        ...
                        <asp:Table ID="Table6" runat="server" Width="100%">
                            ...
                            <asp:TableRow>
                                <asp:TableCell Width="100%">
                                    <asp:GridView EmptyDataText="<div style='padding: 10px; color: red; font: 12px bold'>No Records Found.</div>" ID="GridView2" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="FCY" SortExpression="FCY">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("CurrencyName")%>'></asp:TextBox></EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("CurrencyName")%>'></asp:Label></ItemTemplate>
                                            </asp:TemplateField>
