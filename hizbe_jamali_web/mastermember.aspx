<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="mastermember.aspx.vb" Inherits="Hizbe_Jamali_Web.mastermember" %>

<%@ Import Namespace="Hizbe_Jamali_Web" %>
                ...
                <div id="content">
                    <div id="contact_us_left_coloumn">
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td colspan="2" align="right">
                                    <asp:Label ID="lblMissing" runat="server" ForeColor="Red" Font-Bold="True" Font-Size="Medium"></asp:Label>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table width="100%">
                            <tr>
                                <td width="40%">
                                    <asp:DropDownList Width="100%" ID="drpLeaders" runat="server" AutoPostBack="True" OnSelectedIndexChanged="drpLeaders_SelectedIndexChanged"></asp:DropDownList>
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:DropDownList ID="cboxStatus1" runat="server"></asp:DropDownList>
                                </td>
                                <td>
                                    <asp:Button ID="btnSearchMember" runat="server" Text="  Search Members  " OnClick="btnSearchMember_Click" />
                                </td>
                            </tr>
                        </table>
                        ...
                        <asp:Table ID="Table6" runat="server" Width="100%">
                            <asp:TableRow>
                                <asp:TableCell Width="100%">
                                    <asp:GridView ID="GridView2" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="False" GridLines="None" HeaderStyle-Width="100px" CssClass="mGrid" AllowPaging="True" Width="100%" OnPageIndexChanging="GridView2_PageIndexChanging" PagerSettings-PageButtonCount="20" PageSize="20" EmptyDataText="<h3 style='color: red; padding: 0 10px;'>No Records Found</h3>">
                                        <RowStyle BackColor="#FFFBD6" ForeColor="#333333" />
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnEdit" CommandName='<%# Eval("Ejamaat")%>' OnCommand="btnEdit_Command" Text="Edit" runat="server" style="color:#333333;"></asp:LinkButton>
                                                    <br />
                                                    <asp:PlaceHolder ID="plcHolder" runat="server" Visible='<%# MemberInfo.IsRejected(Eval("Ejamaat"))%>'>
                    ...
                    <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Height="70%" Width="50%" Style="display: none">
